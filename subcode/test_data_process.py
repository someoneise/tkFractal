...
def test_read_data():
    param_file = "subcode/est_data.txt"  # Replace with the path to your test data file
...
def test_generateDravesIFS():
    ...
    x_points, y_points, c_points = generateDravesIFS(coeffs, sums, probabilities, iterations=100)
